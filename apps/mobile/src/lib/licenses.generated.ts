 ...
 *
 * The 213 open-source packages that ship inside the app, for the
...
export const LICENSE_SUMMARY: readonly (readonly [string, number])[] = [["MIT",191],["ISC",9],["Apache-2.0",4],["BlueOak-1.0.0",4],["MIT AND OFL-1.1",3],["0BSD",1],["BSD-2-Clause",1]] as const;

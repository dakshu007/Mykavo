    ...
    articles: [
      {
        ...
        description:
          "What the Free and Pro plans include, what the limits are, and how they are enforced.",
        keywords: ["mykavo pricing", "website monitoring pricing", "free website monitoring"],
        capsule:
          "MyKavo has two plans. Free covers one website with five monitored pages, weekly scans and 30 days of history, with no card required. Pro is $20 a month for eight websites with fifteen monitored pages each, daily scans, a year of history and five seats. Limits are enforced on the server, not in the interface.",
        blocks: [
          {
            type: "table",
            head: ["", "Free", "Pro"],
            rows: [
              ["Price", "$0", "$20 / month"],
              ["Websites", "1", "8"],
              ["Monitored pages per website", "5", "15"],
              ["Scan frequency", "Weekly", "Daily"],
              ["History retained", "30 days", "1 year"],
              ["Workspace seats", "1", "5"],
              ["Site audit", "Included", "Included"],
              ["Uptime and SSL monitoring", "Included", "Included"],
              ["Email, Slack, Discord and webhook alerts", "Included", "Included"],
            ],
          },

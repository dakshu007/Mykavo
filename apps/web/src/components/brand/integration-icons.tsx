/**
 * Brand marks for the services MyKavo delivers alerts into.
 *
 * Real logos rather than generic glyphs: a lucide hash standing in for Slack
 * and a speech bubble for Discord read as "chat app", not as the specific
 * product somebody is looking for. These are used nominatively - to identify
 * an integration that genuinely exists - and each is drawn in its owner's
 * official colours rather than recoloured to match this site.
 *
 * That is also why they sit on white tiles here. The gold tile treatment the
 * rest of the landing page uses would tint a four-colour Slack mark into
 ...
 *
 * Exact official colours and geometry. Google's branding guidelines require
 * the mark to be reproduced unmodified, so this is never recoloured or
 * monochromed to suit a dark button.
 */
